...
<body>
  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: black; font-size: 26px;"><strong>FashionHub</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
  ...
  <table width="100%" style="background: #F7F7F7; padding:0 5 0 5px;" class="font">
    <tr>
        ...
        <td>
          <p class="font">
            <h3><span style="color: black;">Invoice:</span> #{{ $order->invoice_no}}</h3>
...
<h3>Products</h3>
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            <h2><span style="color: black;">Subtotal:</span>Rs.{{ $order->amount }}</h2>
            <h2><span style="color: black;">Total:</span> Rs.{{ $order->amount }}</h2>
            {{-- <h2><span style="color: black;">Full Payment PAID</h2> --}}
        </td>
    </tr>
  </table>
